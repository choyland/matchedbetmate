...
namespace MatchedBetMate.iOS.Infrastructure.Reachability
{
    ...
    public static class Reachability
    {
        ...
        public static bool IsAdHocWiFiNetworkAvailable(out NetworkReachabilityFlags flags)
        {
            if (_adHocWiFiNetworkReachability == null)
            {
                ...
                _adHocWiFiNetworkReachability = new NetworkReachability(ipAddress.MapToIPv6());
        ...
        static bool IsNetworkAvailable(out NetworkReachabilityFlags flags)
        {
            if (_defaultRouteReachability == null)
            {
                ...
                _defaultRouteReachability = new NetworkReachability(ipAddress.MapToIPv6());
